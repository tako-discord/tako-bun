	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand((subcommand) =>
			subcommand
				...
				.setDescriptionLocalizations(slashCommandTranslator('info.badge.description', 'info'))
				.addStringOption((option) =>
					option
						.setName(i18next.t('info.badge.options.badge.name', { ns: 'info' }))
						.setNameLocalizations(slashCommandTranslator('info.badge.options.badge.name', 'info'))
						.setDescription(i18next.t('info.badge.options.badge.description', { ns: 'info' }))
						.setDescriptionLocalizations(slashCommandTranslator('info.badge.options.badge.description', 'info'))
				...
				await interaction.reply({
					embeds: [
						createEmbed({
							...
							description: i18next.t('info.badge.notFound.description', { ns: 'info', badge }),
